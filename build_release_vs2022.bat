...
echo on
cmake .. -G "Visual Studio 17 2022" -A x64 -DBBL_RELEASE_TO_PUBLIC=1 -DORCA_TOOLS=ON %SIG_FLAG% -DCMAKE_PREFIX_PATH="%DEPS%/usr/local" -DCMAKE_INSTALL_PREFIX="./Snapmaker_Orca" -DCMAKE_BUILD_TYPE=%build_type% -DCMAKE_CXX_FLAGS_RELEASE="/MD /Od /Ob0 /DNDEBUG" -DWIN10SDK_PATH="%WindowsSdkDir%Include\%WindowsSDKVersion%\"
