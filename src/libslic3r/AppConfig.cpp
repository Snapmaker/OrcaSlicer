...
static const std::string VERSION_CHECK_URL_STABLE = "https://api.github.com/repos/womendoushihaoyin/OrcaSlicer/releases/latest";
static const std::string VERSION_CHECK_URL = "https://api.github.com/repos/womendoushihaoyin/OrcaSlicer/releases";
static const std::string PROFILE_UPDATE_URL = "https://api.github.com/repos/womendoushihaoyin/presets_test/releases/latest";
