...
void PrintConfigDef::init_fff_params()
{
    ...
    */
    ...
    def->tooltip = L("Connect an infill line to an internal perimeter with a short segment of an additional perimeter. "
                     "If expressed as percentage (example: 15%) it is calculated over infill extrusion width. Snapmaker Orca tries to connect two close infill lines to a short perimeter segment. If no such perimeter segment "
...
//    def->min = 0;
    ...
    for (const char *opt_key : {
        ...
        "wipe_distance",
        // bools
        "retract_when_changing_layer", "wipe", "z_hop_when_prime",
        // percents
        "retract_before_wipe",
...
CLIMiscConfigDef::CLIMiscConfigDef()
{
    ...
    def->tooltip = L("This version of Snapmaker_Orca may not understand configurations produced by the newest Snapmaker_Orca versions. "
                     "For example, newer Snapmaker_Orca may extend the list of supported firmware flavors. One may decide to "
    ...
    def->tooltip = L("If enabled, the command line arguments are sent to an existing instance of GUI Snapmaker_Orca, "
