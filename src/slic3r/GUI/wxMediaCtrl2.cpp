...
wxMediaCtrl2::wxMediaCtrl2(wxWindow *parent)
{
    ...
    if (m_native_wayland && is_gstreamer_feature_available("gtksink"))
        ...
        m_gtk_sink_error = _L("Native Wayland liveview requires the GStreamer GTK video sink. Please install the gtksink plugin for GStreamer, then restart Snapmaker Orca.");
