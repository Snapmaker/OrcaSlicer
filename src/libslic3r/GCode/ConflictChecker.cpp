...
ConflictComputeOpt ConflictChecker::line_intersect(const LineWithID &l1, const LineWithID &l2)
{
    ...
    if (intersect) {
        ...
        bool          both_support = r1 == ExtrusionRole::erSupportMaterial || r1 == ExtrusionRole::erSupportMaterialInterface || r1 == ExtrusionRole::erSupportMaterialInterfaceFirst || r1 == ExtrusionRole::erSupportMaterialInterfaceMiddle || r1 == ExtrusionRole::erSupportMaterialInterfaceTop || r1 == ExtrusionRole::erSupportTransition;
        both_support = both_support && ( r2 == ExtrusionRole::erSupportMaterial || r2 == ExtrusionRole::erSupportMaterialInterface || r2 == ExtrusionRole::erSupportMaterialInterfaceFirst || r2 == ExtrusionRole::erSupportMaterialInterfaceMiddle || r2 == ExtrusionRole::erSupportMaterialInterfaceTop || r2 == ExtrusionRole::erSupportTransition);
