...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "nozzle_type", "nozzle_hrc","auxiliary_fan", "nozzle_volume", "nozzle_flush_dataset","upward_compatible_machine", "z_hop_types", "z_hop_when_prime", "travel_slope", "retract_lift_enforce","support_chamber_temp_control","support_air_filtration","printer_structure",
