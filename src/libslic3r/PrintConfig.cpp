...
static const t_config_enum_values s_keys_map_BedType = {
    ...
    { "Cold Pressed Steel Plate", btCPSP },
};
...
void PrintConfigDef::init_fff_params()
{
    ...
    def             = this->add("cold_pressed_steel_plate_temp", coInts);
    def->label      = L("Other layers");
    def->tooltip    = L("Bed temperature for layers except the initial one. "
                           "A value of 0 means the filament does not support printing on the Cold Pressed Steel Plate.");
    def->sidetext   = u8"\u2103" /* °C */; // degrees Celsius, don't need translation
    def->full_label = L("Bed temperature");
    def->min        = 0;
    def->max        = 300;
    ...
    def             = this->add("cold_pressed_steel_plate_temp_initial_layer", coInts);
    def->label      = L("Initial layer");
    def->full_label = L("Initial layer bed temperature");
    def->tooltip    = L("Bed temperature of the initial layer. "
                           "A value of 0 means the filament does not support printing on the Cold Pressed Steel Plate.");
    ...
    def->enum_values_u1.emplace_back("Cold Pressed Steel Plate");
    ...
    def->enum_labels_u1.emplace_back(L("Cold Pressed Steel Plate"));
    // U1 use 8 when open support_multi_bed_types
    ...
    def->enum_values_ex.emplace_back("Cold Pressed Steel Plate");
    ...
    def->enum_labels_ex.emplace_back(L("Cold Pressed Steel Plate"));
